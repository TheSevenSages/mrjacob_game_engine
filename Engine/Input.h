...
public:
    ...
    static void LateUpdate(); // Call at the very end of frame.

    static bool GetKey(std::string keycode); // Returns true every frame that a key is being held down.
    static bool GetKeyDown(std::string keycode); // Returns true the frame that a key gets pressed down.
    static bool GetKeyUp(std::string keycode); // Returns true the frame that a key stops getting pressed.

    static glm::vec2 GetMousePosition(); // Returns the current mouse position.
    
    static bool GetMouseButton(int button); // Returns true every frame that a mouse button is being held down.
    static bool GetMouseButtonDown(int button); // Returns true the frame that a mouse button gets pressed down.
    static bool GetMouseButtonUp(int button); // Returns true the frame that a mouse button stops getting pressed.
    static float GetMouseScrollDelta(); // Returns the change in the mouse scroll position between this frame and the last.
